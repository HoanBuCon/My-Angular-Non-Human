...
const firstLoginForm = document.querySelector(".auth-subform");
...
if (newPasswordInput && confirmPasswordInput && firstLoginForm && submitButton) {
    setupErrorClearing(firstLoginForm, errorClass);
    ...
    firstLoginForm.addEventListener("submit", (event) => {
        ...
        Toast.success("Đổi mật khẩu lần đầu thành công! Vui lòng đăng nhập lại.");
        setTimeout(() => {
